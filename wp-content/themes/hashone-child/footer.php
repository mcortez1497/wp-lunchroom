		...
		<div id="hs-bottom-footer">
			<div class="hs-container">
				...
				<div class="hs-site-info">
					...
					<span class="sep"> | </span>
					<?php printf( esc_html__( 'By Michael Cortez based on %1$s by %2$s', 'hashone' ), '<a href="https://hashthemes.com/wordpress-theme/hashone/" target="_blank">Hashone</a>', 'Hash Themes' ); ?>
				</div><!-- #site-info -->
			</div>
		</div>
	</footer><!-- #colophon -->
